...
const postCar = async (userData) => {
  ...
  try {
    ...
    await page.type('#password_login', config.seminuevos.password);
    ...
    await page.type('#input_precio', userData.price);
    ...
    await description[0].type(userData.description);
